...
#file_path ='\\\\192.168.1.2\\JHT-Design\\JHT-CKP-CIP-文件管理中心\文件中心\\12-U8数据查询\\003-金海通正式账套\\03-请购单执行列表-每日更新-王荣荣\\'
file_name = "分颜色"+datetime.now().strftime('%Y-%m-%d') + "请购执行列表.xls"
#file_name = "test.xls"
